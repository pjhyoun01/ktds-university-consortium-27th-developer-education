...
import com.ktds.edu.fp.basic.stream.advanced.utils.ArrayUtil;
import com.ktds.edu.fp.basic.stream.advanced.utils.StringUtil;
...
public class City {
	...
	public static List<City> loadCityData(){
		String path = "C:\\Users\\pjhyo\\Downloads\\java-stream-countries-states-cities-database-master\\csv\\cities.csv";
		try {
