...
public class BoardQuery {
	...
	public static String createNewArticleQuery() {
	...
	public static String readAllArticleQuery() {
		StringBuffer query = new StringBuffer();
	...
	public static String increaseViewCountQuery() {
		StringBuffer query = new StringBuffer();
	...
	public static String readOneArticleQuery() {
		StringBuffer query = new StringBuffer();
		query.append(" SELECT ID");
		query.append(" 		, TITLE");
		query.append(" 		, CONTENT");
	...
	public static String modifyArticleQuery() {
		StringBuffer query = new StringBuffer();
		query.append(" UPDATE BOARD ");
